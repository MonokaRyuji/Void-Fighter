...
const bgmGamePlay = new Audio('assets/audio/Free_Bird.mp3');
...
bgmMainMenu.volume = 1;
bgmSkinSelection.volume = 1;
bgmGamePlay.volume = 0;
bgmGameOver.volume = 1;
...
function initializeGame() {
  player = { x: canvas.width / 2 - 58, y: canvas.height - 130, width: 120, height: 120, speed: 15};
  bullets = [];
  enemies = [];
  score = 0;
  lives = 3;
...
function updateGame() {
  ...
  bullets.forEach(b => {
    b.x += b.speedX; // Gerakkan peluru secara horizontal
    b.y -= b.speedY; // Gerakkan peluru secara vertikal
  });  
